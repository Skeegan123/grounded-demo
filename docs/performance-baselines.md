...
| Measurement | Before OCR removal | September 4, 2026 baseline | Budget |
| --- | ---: | ---: | ---: |
| Raw | 1,759,071 bytes | 772,186 bytes | 870,000 bytes |
| gzip | 343,680 bytes | 191,441 bytes | 215,000 bytes |

The budgets leave 12.7% raw and 12.3% gzip headroom over the baseline. This is
...
The September 2, 2026 single-run Lighthouse baseline was captured on macOS 26.4 with
